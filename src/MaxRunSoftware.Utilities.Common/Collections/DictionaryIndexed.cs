...
[Serializable]
public sealed class DictionaryIndexed<TKey, TValue> : IDictionary<TKey, TValue>
{
    ...
    public DictionaryIndexed() => d = new();

    public DictionaryIndexed(IEqualityComparer comparer) => d = new(comparer);
