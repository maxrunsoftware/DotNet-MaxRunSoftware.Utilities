...
public class ConsumerProducerThread<TConsume, TProduce> : ConsumerProducerThreadBase<TConsume, TProduce>
{
    ...
    public ConsumerProducerThread(
        BlockingCollection<TConsume> consumerQueue,
        BlockingCollection<TProduce> producerQueue,
        Func<TConsume, TProduce> func,
        ILoggerProvider loggerProvider
    ) : base(consumerQueue, producerQueue, loggerProvider) => this.func = func.CheckNotNull(nameof(func));
