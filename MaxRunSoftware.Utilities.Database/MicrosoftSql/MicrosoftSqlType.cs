...
public enum MicrosoftSqlType
{
    ...
    /// </summary>
    [SqlType(DbType.Binary)] Image = 7,

    /// <summary>
    /// <see cref="T:System.Int32" />. A 32-bit signed integer.
    /// </summary>
    [SqlType(DbType.Int32)] Int = 8,
    ...
    /// </summary>
    [SqlType(DbType.String)] NText = 11,
    ...
    /// </summary>
    [SqlType(DbType.DateTime)] SmallDateTime = 0xF,

    /// <summary>
    /// <see cref="T:System.Int16" />. A 16-bit signed integer.
    /// </summary>
    [SqlType(DbType.Int16)] SmallInt = 0x10,
    ...
    /// </summary>
    [SqlType(DbType.Binary)] Timestamp = 19,

    /// <summary>
    /// <see cref="T:System.Byte" />. An 8-bit unsigned integer.
    /// </summary>
    [SqlType(DbType.Byte)] TinyInt = 20,
    ...
    /// </summary>
    [SqlType(DbType.Binary)] VarBinary = 21,
    ...
    /// </summary>
    [SqlType(DbType.AnsiString)] VarChar = 22,
    ...
    /// </summary>
    [SqlType(DbType.Object)] Variant = 23,
    ...
    /// </summary>
    [SqlType(DbType.DateTime2)] DateTime2 = 33,
    ...
    /// through +14:00.
    /// </summary>
    [SqlType(DbType.DateTimeOffset)] DateTimeOffset = 34
}
