...
public enum SqlMySqlType
{
    ...
    /// </summary>
    [SqlType(DbType.DateTime)] Timestamp = 7,

    /// <summary>
    /// Date The supported range is '1000-01-01' to '9999-12-31'.
    /// </summary>
    [SqlType(DbType.Date)] Date = 10,

    /// <summary>
    /// The range is '-838:59:59' to '838:59:59'.
    /// </summary>
    [SqlType(DbType.Time)] Time = 11,

    /// <summary>
    /// The supported range is '1000-01-01 00:00:00' to '9999-12-31 23:59:59'.
    /// </summary>
    [SqlType(DbType.DateTime)] DateTime = 12,
    ...
    /// </summary>
    [SqlType(DbType.String)] VarString = 15,

    /// <summary>
    /// Bit-field data type
    /// </summary>
    [SqlType(DbType.Byte)] Bit = 16,

    /// <summary>
    /// JSON
    /// </summary>
    [SqlType(DbType.String)] JSON = 245,

    /// <summary>
    /// New Decimal
    /// </summary>
    [SqlType(DbType.Decimal)] NewDecimal = 246,
    ...
    /// </summary>
    [SqlType(DbType.String)] Enum = 247,
    ...
    /// </summary>
    [SqlType(DbType.Binary)] Binary = 754,

    /// <summary>
    /// Variable length binary string.
    /// </summary>
    [SqlType(DbType.Binary)] VarBinary = 753,

    /// <summary>
    /// A text column with a maximum length of 255 (2^8 - 1) characters.
    /// </summary>
    [SqlType(DbType.String)] TinyText = 749,

    /// <summary>
    /// A text column with a maximum length of 16777215 (2^24 - 1) characters.
    /// </summary>
    [SqlType(DbType.String)] MediumText = 750,

    /// <summary>
    /// A text column with a maximum length of 4294967295 or 4G (2^32 - 1) characters.
    /// </summary>
    [SqlType(DbType.String)] LongText = 751,

    /// <summary>
    /// A text column with a maximum length of 65535 (2^16 - 1) characters.
    /// </summary>
    [SqlType(DbType.String)] Text = 752,

    /// <summary>
    /// A guid column.
    /// </summary>
    [SqlType(DbType.Guid)] Guid = 854
}
