...
public interface IFtpClient : IDisposable
{
    ...
    void GetFile(string remoteFile, string localFile) => GetFile(remoteFile, localFile, null);

    void GetFile(string remoteFile, string localFile, Action<FtpClientProgress>? handlerProgress);

    void PutFile(string remoteFile, string localFile) => PutFile(remoteFile, localFile, null);
